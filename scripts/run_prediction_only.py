...
PREDICTION_EXPORT_COLS = [
    ...
    "target_future_drawdown",
    "target_big_up_label",
    "target_big_down_label",
    "target_avoid_loss_label",
    "target_reduce_position_worth_label",
    "pred_ret",
    "pred_up_prob",
    "pred_trade_prob",
    "pred_big_up_prob",
    ...
    "pred_future_drawdown",
    "pred_big_up_label_prob",
    "pred_big_down_label_prob",
    "pred_avoid_loss_label_prob",
    "pred_reduce_position_worth_label_prob",
